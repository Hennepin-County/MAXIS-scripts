...
'This part takes care of remaining navigation buttons, designed to go to a single panel using the maxis case number.
    ...
    If ButtonPressed = CLSM_button then call navigate_to_MAXIS_screen("CCOL", "CLDL") 'Claim Repayment Agreement (CLDL)
	...
	If ButtonPressed = CLIP_button then call navigate_to_MAXIS_screen("CCOL", "CLIV") 'Claim Inquiry - By Vendor (CLIV)
 	If ButtonPressed = CLSM_button then call navigate_to_MAXIS_screen("CCOL", "CLRA") 'Claim Repayment Agreement (CLRA)
	...
	If ButtonPressed = CTHW_button then call navigate_to_MAXIS_screen("CCOL", "CTHV") 'Claim Trans Hist By Vendor (CTHV)
