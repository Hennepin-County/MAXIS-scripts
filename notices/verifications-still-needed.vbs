...
BeginDialog Verifications_Still_Needed_Dialog, 0, 0, 341, 320, "Verifications Still Needed Dialog"
  EditBox 95, 10, 45, 15, MAXIS_case_number
  DropListBox 210, 10, 90, 15, "Select one..."+chr(9)+"SPEC/MEMO"+chr(9)+"Word Document", delivery_option
  ...
  EditBox 70, 300, 160, 15, worker_signature
  ...
  Text 5, 305, 60, 10, "Worker Signature:"
  ...
  Text 155, 15, 55, 10, "Delivery option:"
...
Do 
    DO
    	...
    	If delivery_option = "Select one..." then err_msg = err_msg & vbNewLine & "* Select a delivery option to provide the inforamtion."     
...
CALL write_variable_in_case_note("* Sent to client via : " & delivery_option)
...
CALL write_variable_in_case_note( "* DHS-2919, or other DHS approved form, was used for initial verification request.")
CALL write_variable_in_case_note("---")
CALL write_variable_in_case_note(worker_signature)
PF3 ' saving case note

If delivery_option = "Word Document" then 
