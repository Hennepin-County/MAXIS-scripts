...
Do
    Do      'Just made this  loop - this needs sever testing.
		...
		If clt_virtual_dropbox_checkbox = checked Then CALL add_words_to_message("*** Submitting Documents:; - Online at infokeep.hennepin.us or MNBenefits.mn.gov; - Use InfoKeep to upload documents directly to your case.; - Mail, Fax, or Drop Boxes at Service Centers.; - More Info: https://www.hennepin.us/economic-supports")
