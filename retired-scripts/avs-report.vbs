...
If AVS_option = "Initial Monthly Upload" then
    ...
    Do
        ...
        case_array(case_status_const,                 entry_record) = False
    ...
    For item = 0 to UBound(case_array, 2)
    	...
    	If PRIV_check = "PRIV" then
            case_array(case_status_const, item) = False
        ...
        Else
            ...
            Do
                ...
                IF Client_PMI = person_PMI then
                    ...
                    Case_array(case_status_const, item) = True
    ...
    For item = 0 to UBound(case_array, 2)
        ...
        If case_array(case_status_const, item) = True then
