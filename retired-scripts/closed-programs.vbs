...
call changelog_update("05/01/2023", "* * * Closed Programs has been retired. * * *##~####~##NOTES - Eligibility Summary will now run every time you press the button for Closed Programs.##~##", "Casey Love, Hennepin County")
		...
		DO
			Do
                ...
                If offer_test_script = True and elig_summ_option_given = False Then
                    ...
                    run_elig_summ = MsgBox("* * * THIS SCRIPT WILL BE RETIRED ON 5/1/2023 * * *" & vbCr & "Please start using Eligibility Summary for denials right away." & vbCr & vbCr &"Run NEW Script - NOTES - Eligibliity Summary?"& vbCr & vbCr & "It appears you are running 'NOTES - Closed Programs' and all programs are supported by 'NOTES - Eligibility Summary'." & vbCr & vbCr & "The script can redirect to run NOTES - Eligibility Summary now. Remember this new script takes some time to gather the details of the approval, but reqquires little input." & vbCr & vbCr & "NOTE: Information entered in this first dialog will NOT carry through." & vbCr & vbCr & "Would you like the script to run NOTES - Eligibility Summary for you now?", vbQuestion + vbYesNo, "Redirect to NOTES - Eligibility Summary")
