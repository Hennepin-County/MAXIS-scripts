		...
		Do
			...
			If show_known_addr = TRUE Then
				BeginDialog Dialog1, 0, 0, 391, 285, "CAF Address"
				  ...
				  Text 125, 225, 65, 45, phone_one_type
			...
			If show_known_addr = FALSE Then
				BeginDialog Dialog1, 0, 0, 391, 285, "CAF Address"
				  ...
				  DropListBox 125, 220, 65, 45, "Select One..."+chr(9)+"Cell"+chr(9)+"Home"+chr(9)+"Work"+chr(9)+"Message Only"+chr(9)+"TTY/TDD", phone_one_type
...
function dlg_page_five_expenses()
	...
	Do
		Do
			...
			BeginDialog Dialog1, 0, 0, 671, 375, "What kinds of expenses do you have?"
...
function dlg_page_six_assets_and_other()
	...
	Do
		Do
			err_msg = ""
			Dialog1 = ""
			BeginDialog Dialog1, 0, 0, 651, 260, "What do you own? Other Information"
