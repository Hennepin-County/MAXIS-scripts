...
DO
    Do
        ...
        If ButtonPressed = print_document_case_button Then run "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe https://hennepin.sharepoint.com/teams/hs-economic-supports-hub/Lists/Forms_List/DispForm.aspx?ID=256"
