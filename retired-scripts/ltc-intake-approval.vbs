...
Call changelog_update("10/27/2023", "*  *  *  *  SCRIPT RETIREMENT NOTICE  *  *  *  *##~####~##This script is being retired on 11/06/2023.##~## ##~##New functionality has been added to NOTES - Health Care Evaluation to support the details from this script into a LTC Intake CASE NOTE. Approval details are supported in NOTES - Eligibility Summary.##~## ##~##THESE UPDATES ARE IN HC EVAL NOW FOR TESTING.", "Casey Love, Hennepin County")
