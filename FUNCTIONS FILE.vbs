...
'Set fso_command = run_another_script_fso.OpenTextFile("E:\VKC dev directory\Script Files\FUNCTIONS FILE.vbs")
...
county_address_line_01 = "1234 Minneapolis Road"
county_address_line_02 = "Minneapolis, MN 55555"
...
function script_end_procedure(closing_message)
	...
	If is_county_collecting_stats  = True then
		...
		'Opening DB
		objConnection.Open "Provider = Microsoft.ACE.OLEDB.12.0; Data Source = S:\Veronica Cary\BlueZone Scripts\Statistics\usage statistics.accdb"
