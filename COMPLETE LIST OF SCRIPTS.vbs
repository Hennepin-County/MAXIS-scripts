...
ReDim Preserve script_array(script_num)		'Resets the array to add one more element to it
Set script_array(script_num) = new script_bowie		'Set this array element to be a new script_bowie. Script details below...
script_array(script_num).script_name			= "ABAWD Minor Child Exemption"
script_array(script_num).description			= "FAITs SNAP eligibility, income and deductions for non-parents with minor children in HH."
script_array(script_num).category               = "ACTIONS"
script_array(script_num).workflows              = ""
script_array(script_num).subcategory            = array("ABAWD")
