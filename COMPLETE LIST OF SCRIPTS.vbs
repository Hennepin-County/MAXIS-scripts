...
script_array(script_num).dlg_keys               = array("Ex")
script_array(script_num).subcategory            = array("")
script_array(script_num).retirement_date		= #09/21/2026#
...
ReDim Preserve script_array(script_num)			'Resets the array to add one more element to it
Set script_array(script_num) = new script_bowie	'Set this array element to be a new script_bowie. Script details below...
script_array(script_num).script_name 			= "Expedited SNAP Applications"
' script_array(script_num).description 			= "Template for noting detail about how expedited was determined for a case."
script_array(script_num).category               = "ADMIN"
script_array(script_num).workflows              = ""
script_array(script_num).tags                   = array("Application", "SNAP")
script_array(script_num).dlg_keys               = array("Exp", "Ex")
script_array(script_num).subcategory            = array("")
script_array(script_num).release_date           = #10/01/2000#
script_array(script_num).hot_topic_link			= ""
script_array(script_num).used_for_elig			= False
...
ReDim Preserve script_array(script_num)   'Resets the array to add one more element to it
Set script_array(script_num) = new script_bowie	'Set this array element to be a new script. Script details below...
script_array(script_num).script_name 			= "No Interview List"											'Script name
' script_array(script_num).description 			= "Puts pending SNAP cases without an interview in the on demand table into an excel list."
script_array(script_num).category               = "ADMIN"
script_array(script_num).workflows              = ""
script_array(script_num).tags                   = array("SNAP")
script_array(script_num).dlg_keys               = array("Ex")
script_array(script_num).subcategory            = array("")
script_array(script_num).release_date           = #07/06/2026#
script_array(script_num).hot_topic_link			= ""
script_array(script_num).used_for_elig			= False
script_array(script_num).policy_references		= array("")						'SEE Line 58 for format'
script_array(script_num).usage_eval				= ""
