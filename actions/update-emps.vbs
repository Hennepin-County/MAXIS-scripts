...
'Start Dialog
BeginDialog fss_code_detail_one, 0, 0, 371, 25, "Update FSS Information from the Status Update"
  Text 5, 10, 45, 10, "Case Number"
  EditBox 55, 5, 50, 15, MAXIS_case_number
  Text 120, 10, 70, 10, "Household member"
  DropListBox 195, 5, 105, 45, HH_Memb_DropDown, clt_to_update
  ButtonGroup ButtonPressed
    PushButton 320, 5, 50, 10, "Enter", enter_detail_button
EndDialog
...
Do 
	...
	client_info = ref_numb & " - " & first_name & " " & last_name
	HH_Memb_DropDown = HH_Memb_DropDown & chr(9) & client_info
	row = row + 1
Loop until row = 20 
	
Dialog fss_code_detail_one
'FIND Case Number
