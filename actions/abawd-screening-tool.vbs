...
Function case_note_and_end
    ...
    Dialog1 = ""
    BeginDialog Dialog1, 0, 0, 166, 105, "ABAWD Screening Tool"
...
Dialog1 = ""
BeginDialog Dialog1, 0, 0, 181, 100, "ABAWD Screening Tool"
...
DO
    ...
    Dialog1 = ""
    BeginDialog Dialog1, 0, 0, 311, 250, "ABAWD Screening Tool"
	...
	Dialog Dialog1  'dialog is run asking for input on if client meets any WREG Exmpetions. If they do they are presumed not abawd, if none are checked it continues to next dialog
    ...
    DO
        ...
        Dialog1 = ""
        BeginDialog Dialog1, 0, 0, 241, 180, "ABAWD Screening Tool"
        ...
        Dialog Dialog1  'dialog is run asking for input on if client meets any ABAWD exemptions. IF they do they are presumed not ABAWD, if none are checked it continues to next dialog
		...
		IF cl_has_abawd_exemption = true and PW_county_check <> User_county_check THEN    'Creating message box for workers screening on out of county cases if member reports ABAWD exemption.
            script_end_procedure("Per discussion with client, member " & member_number & " is NOT an ABAWD. Unable to case note due to case being in another county. Process accordingly.")
		ElseIf cl_has_abawd_exemption = true THEN
			call case_note_and_end
		End If
        ...
        DO
            ...
            Dialog1 = ""
            BeginDialog Dialog1, 0, 0, 366, 95, "ABAWD Screening Tool"
    		...
    		Dialog Dialog1   'dialog is run asking if client has earned any additional months. If client has not script will case note items checked.
    		cancel_confirmation
    		IF ButtonPressed = previous_button then exit do
