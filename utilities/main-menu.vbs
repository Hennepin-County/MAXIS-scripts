...
call changelog_update("08/19/2024", "***** NEW SCRIPT *****##~## UTILITIES - Find MEMB in MMIS##~##This script will display any MMIS SPANs for a single household member that are open or were open in the past 4 months.", "Casey Love, Hennepin County")
Call changelog_update("10/09/2023", "UTILITIES MENU Update##~####~##We have updated the UTILITIES Menu to make it work a little better:##~##  -  Added the '?' buttons back to open script instructions from the menu.##~##  -  Removed the view of ALL Utility scripts as there were just too many.##~##  -  Added a 'TOP' Utility script view to see the most commonly used script right away.##~##  -  Added a 'REQUESTS' option to see all Utilitiy scripts that will send a request to a specific team/area.##~####~##This menu updates were necessary because of the number of scripts in this area, but we intend for the updates to also make it easier to find the script you need. Please report any issues, concerns, or ideas to us at HSPH.EWS.BlueZoneScripts@hennepin.us.", "Casey Love, Hennepin County")
