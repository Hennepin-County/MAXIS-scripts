...
Call open_URL_in_browser("http://www.dhs.state.mn.us/onesource")
' run "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe http://www.dhs.state.mn.us/onesource"
...
'     .Get "http://www.dhs.state.mn.us/onesource"
'     .FindElementById("j_username").SendKeys "hcresource"
' 	.FindElementById("j_password").SendKeys "ONE5ource"
