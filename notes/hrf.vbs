...
Call changelog_update("05/05/2025", "Removed handling for MFIP, GA, and UHFS programs due to implementation of six-month budgeting. Script now only handles for MSA.", "Mark Riegel, Hennepin County")
...
Do
    Do
        ...
        If MSA_check = 0 then err_msg = err_msg & "* You must check the MSA checkbox for the Program Recertifying."
        ...
        If HRF_panels = 0 then script_end_procedure_with_error_report("This case is not subject to monthly reporting. The script will now end.")
