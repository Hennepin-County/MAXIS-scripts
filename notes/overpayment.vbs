...
CALL changelog_update("02/01/2018", "Updated script to write amount in case note.", "MiKayla Handley, Hennepin County")
...
Call write_variable_in_CASE_NOTE(First_Program & " Overpayment Claim # " & First_OP  & "Amount: " & First_AMT &  " " & First_from_IEVS_month & "/" &  First_from_IEVS_year & " through "  & First_to_IEVS_month & "/" &  First_to_IEVS_year & " Amount: " & First_amount)
IF Second_OP <> "" THEN CALL write_variable_in_case_note(Second_Program &  "Overpayment Claim # " & Second_OP  & "Amount: " & Second_AMT & " " & Second_from_IEVS_month & "/" &  Second_from_IEVS_year & " through "  & Second_to_IEVS_month & "/" &  Second_to_IEVS_year & " Amount: " & Second_amount)
IF Third_OP <> "" THEN CALL write_variable_in_case_note(Third_Program &  "Overpayment Claim # " & Third_OP & "Amount: " & Third_AMT & " " & Third_from_IEVS_month & "/" &  Third_from_IEVS_year & " through "  & Third_to_IEVS_month & "/" &  Third_to_IEVS_year & " Amount: " & Third_amount)
