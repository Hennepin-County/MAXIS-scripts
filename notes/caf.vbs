...
If vars_filled = False Then
    ...
    function new_autofill_editbox_from_MAXIS(HH_member_array, panel_read_from, variable_written_to)
    ...
    call new_autofill_editbox_from_MAXIS(HH_member_array, "ABPS", ABPS)
