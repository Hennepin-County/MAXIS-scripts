...
If update_addr_checkbox = checked Then
    ...
    Call back_to_SELF
    Call access_ADDR_panel("WRITE", notes_on_address, new_resi_one, "", new_resi_city, new_resi_state, new_resi_zip, "", "", "", "", living_situation_status, new_mail_one, "", new_mail_city, new_mail_state, new_mail_zip, new_addr_effective_date, "", new_phone_one, new_phone_two, new_phone_three, phone_one_type, phone_two_type, phone_three_type)
