	...
	DO
		...
		DO
			Do
                ...
                If SNAP_check = checked Then offer_test_script = True
                If cash_check = checked and ga_status = "INACTIVE" and msa_status = "INACTIVE" and mfip_status = "APP CLOSE" and dwp_status = "INACTIVE" and grh_status = "INACTIVE" Then offer_test_script = True
                If cash_check = checked and (ga_status = "APP CLOSE" or msa_status = "APP CLOSE" or dwp_status = "APP CLOSE" or grh_status = "APP CLOSE") Then offer_test_script = False
                ...
                If offer_test_script = True and elig_summ_option_given = False Then
                    ...
                    ' run_elig_summ = MsgBox("It appears you are running 'NOTES - Closed Programs' on a case that has been processed for SNAP and/or MFIP. In this case the new script 'NOTES - Eligibility Summary' is available to use to document the eligibility results for these programs." & vbCr & vbCr & "The script can redirect to run NOTES - Eligibility Summary now. Remember this new script takes some time to gather the details of the approval, but reqquires little input." & vbCr & vbCr & "Would you like the script to run NOTES - Eligibility Summary for you now?", vbQuestion + vbYesNo, "Redirect to NOTES - Eligibility Summary")
