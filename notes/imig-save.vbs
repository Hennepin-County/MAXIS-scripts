...
IF nation_vietnam <> "Select One:" or nation_vietnam <> "Native Amer Born Can/Mex" THEN Call write_bullet_and_variable_in_case_note("Status during Vietnam War", nation_vietnam)
