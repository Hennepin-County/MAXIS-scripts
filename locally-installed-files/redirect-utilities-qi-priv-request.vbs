...
BZ_writer_run = False
If user_ID_for_validation = "CALO001" Then BZ_writer_run = True
If user_ID_for_validation = "ILFE001" Then BZ_writer_run = True
If user_ID_for_validation = "MEGE001" Then BZ_writer_run = True
...
If user_ID_for_validation = "ASRE002" Then BZ_writer_run = True
...
'LOADING SCRIPT
script_url = script_repository & "/utilities/request-access-to-priv-case.vbs"
