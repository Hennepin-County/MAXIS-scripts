...
If user_ID_for_validation = "CALO001" OR user_ID_for_validation = "ILFE001" OR user_ID_for_validation = "WFS395"Then
	...
	script_url = "C:\MAXIS-Scripts/admin/on-demand-waiver-applications-dashboard.vbs"
Else
	...
	script_url = "https://raw.githubusercontent.com/Hennepin-County/MAXIS-scripts/667-on-demand-adding-more-data-columns/admin/on-demand-waiver-applications-dashboard.vbs"
	run_locally = False
End If
...
'LOADING SCRIPT
' script_url = script_repository & "/admin/on-demand-applications-dashboard.vbs"
