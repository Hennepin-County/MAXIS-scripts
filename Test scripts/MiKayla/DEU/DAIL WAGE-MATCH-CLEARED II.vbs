...
EMReadScreen source_income, 75, 8, 28
...
Elseif instr(source_income, "EMPLOYER:") THEN 					  'establishing the length of the variable
		position = InStr(source_income, "EMPLOYER:")   'establishes employer as being before the deliminator
Else
