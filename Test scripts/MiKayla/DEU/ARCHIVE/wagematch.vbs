''GATHERING STATS===========================================================================================
name_of_script = "DAIL-NONWAGE-MATCH-CLEARED.vbs"
start_time = timer
STATS_counter = 1
...
'----------------------------------------------------------------Defaulting checkboxes to being checked (per DEU instruction)
  ...
  start_a_blank_CASE_NOTE
	IF IEVS_type = "UBEN" THEN CALL write_variable_in_CASE_NOTE("-----" & IEVS_month & "/" & IEVS_year & " NON-WAGE MATCH " & "(" & first_name & ") DIFF NOTICE SENT-----")
