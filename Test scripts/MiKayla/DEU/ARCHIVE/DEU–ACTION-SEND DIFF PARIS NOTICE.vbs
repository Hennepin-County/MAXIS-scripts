...
call changelog_update("09/27/2017", "Updated functionality when searching for more than one match. Also added information to closing message box if a wage match needing a difference notice cannot be found.", "MiKayla Handley, Hennepin County")
