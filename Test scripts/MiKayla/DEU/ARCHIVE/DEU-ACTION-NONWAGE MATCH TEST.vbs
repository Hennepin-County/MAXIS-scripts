''GATHERING STATS===========================================================================================
name_of_script = "NONWAGE MATCH TEST.vbs"
start_time = timer
STATS_counter = 1
...
CALL changelog_update("12/12/2017", "Updated to add UBEN match handling.", "MiKayla Handley, Hennepin County")
...
IF ives_type = UNVI THEN non_wage = True
IF ives_type = UBEN THEN non_wage = True

If non_wage <> True THEN script_end_procedure("This is not a Non-wage match. Please select a Non-wage match, and run the script again.")
...
IF IEVS_type = "UNVI" THEN CALL write_value_and_transmit("UNVI", 20, 71)   'navigates to UNVI
ELSE IEVS_type <> "UNVI" THEN CALL write_value_and_transmit("IEVP", 20, 71) 
END IF
