...
BeginDialog CC_Cleared_dialog, 0, 0, 281, 225, "Cleared CC-Claim Entered"
  ...
  CheckBox 15, 125, 120, 10, "Earned Income disregard allowed", EI_checkbox
  DropListBox 220, 120, 45, 15, "Select One:"+chr(9)+"YES"+chr(9)+"NO", fraud_referral
  EditBox 70, 140, 70, 15, Reason_OP
  EditBox 70, 160, 70, 15, EVF_date
  ...
  Text 5, 165, 65, 10, "Income verification:"
  Text 200, 80, 20, 10, "AMT:"
  Text 15, 145, 50, 10, "Reason for OP: "
  Text 75, 60, 10, 10, "To:"
  Text 10, 60, 20, 10, "From:"
  Text 200, 40, 20, 10, "AMT:"
  Text 155, 165, 65, 10, "Total FED HC AMT:"
  Text 165, 125, 55, 10, "Fraud referral:"
