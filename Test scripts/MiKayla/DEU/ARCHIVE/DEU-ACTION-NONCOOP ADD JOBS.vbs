...
start_a_blank_CASE_NOTE
	...
	Call write_bullet_and_variable_in_CASE_NOTE("Source of income", Employer_info)
...
LOOP UNTIL are_we_passworded_out = false
	...
	EMReadScreen date_hired, 10, row, col + 16
...
IF match_answer_droplist = "NO - run NEW HIRE" THEN     
	...
	CALL write_variable_in_case_note("-NDNH " & new_hire_third_line & " " & employer & " unreported to agency-")
	CALL write_variable_in_case_note("-NDNH " & new_hire_fourth_line & " " & employer & " unreported to agency-")
	CALL write_variable_in_case_note("---")
...
IF match_answer_droplist = "YES - INFC clear match" THEN
   ...
   EndDialog
	...
	Row = 9	
 	'checking to see if matchis know to the agency, therefore acted on'
    DO 
		DO
	...
	transmit
	'please review ecf to ensure verifaction has been sent'
	PF3
	PF3
	...
	start_a_blank_CASE_NOTE
		...
		CALL write_variable_in_case_note("---")
		CALL write_variable_in_case_note("* Reviewed ECF for requested verifcations and MAXIS for correctly budgeted income.")
	...
	ELSEIF Emp_known_droplist = "NO - See Next Question" THEN 
		CALL write_variable_in_case_note("-NDNH " & new_hire_first_line & " INFC cleared ureported to agency-")
		CALL write_variable_in_case_note("DATE HIRED: " & date_hired)
		CALL write_variable_in_case_note("EMPLOYER: " & employer)
		CALL write_variable_in_case_note(new_hire_third_line)
		CALL write_variable_in_case_note(new_hire_fourth_line)
		CALL write_variable_in_case_note("---")
		CALL write_variable_in_case_note("* Reviewed ECF for requested verifcations updated INFC/HIRE accordingly")
