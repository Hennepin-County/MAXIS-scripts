...
CALL changelog_update("01/07/2018", "Updated for footer month handling when 2 or more DAILS are present.", "MiKayla Handley, Hennepin County")
...
BeginDialog NDNH_only_dialog, 0, 0, 271, 65, "National Directory of New Hires"
  ...
  Text 5, 25, 265, 10, "Reminder that client must be provided 10 days to return requested verification(s)"
EndDialog
...
LOOP UNTIL are_we_passworded_out = false
	...
	If IsDate(date_hired) = TRUE THEN 
		MsgBox date_hired
	  date_hired = trim(date_hired)
	Else	
		 MsgBox "*** NOTICE!!! ***" & vbNewLine & date_hired & vbNewLine
