''GATHERING STATS===========================================================================================
name_of_script = "UNVI non-wage match no dail.vbs"
start_time = timer
STATS_counter = 1
...
CALL changelog_update("12/19/2017", "Initial version.", "MiKayla Handley, Hennepin County")
...
BeginDialog case_number_dialog, 0, 0, 126, 85, "Enter the case number"
  EditBox 60, 5, 55, 15, MAXIS_case_number
  EditBox 60, 25, 20, 15, MAXIS_footer_month
  DropListBox 60, 45, 60, 15, "Select One:"+chr(9)+"1"+chr(9)+"2"+chr(9)+"3"+chr(9)+"4"+chr(9)+"YEAR", IEVS_quarter
  ButtonGroup ButtonPressed
    OkButton 35, 65, 40, 15
    CancelButton 80, 65, 40, 15
  Text 5, 10, 50, 10, "Case Number: "
  Text 5, 50, 45, 10, "Match Period:"
...
IF IEVS_quarter = "1" THEN
                IEVS_period = "01-" & CM_yr & "/03-" & CM_yr_minus_cm_1
ELSEIF IEVS_quarter = "2" THEN
                IEVS_period = "04-" & CM_yr & "/06-" & CM_yr_minus_cm_1
ELSEIF IEVS_quarter = "3" THEN
                IEVS_period = "07-" & CM_yr & "/09-" & CM_yr_minus_cm_1
ELSEIF IEVS_quarter = "4" THEN
                IEVS_period = "10-" & CM_minus_6_yr & "/12-" & CM_minus_6_1
