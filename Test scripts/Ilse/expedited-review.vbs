...
'Call create_outlook_email("Deborah.Lechner@Hennepin.us; Jessica.Hall@Hennepin.us; Tanya.Payne@hennepin.us", "", "Today's EXP SNAP report is ready.", "Path to folder: T:\Eligibility Support\Restricted\QI - Quality Improvement\REPORTS\SNAP\EXP SNAP Project", "", True)
Call create_outlook_email("Ilse.Ferris@hennepin.us", "", "Testing email for EXP SNAP Project. Today's report is ready.", "Path to folder: T:\Eligibility Support\Restricted\QI - Quality Improvement\REPORTS\SNAP\EXP SNAP Project", "", True)
