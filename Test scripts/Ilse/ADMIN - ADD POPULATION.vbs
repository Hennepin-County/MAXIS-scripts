...
Do
    ...
    If basket_number = "X127EG4" then suggested_population = "Adults - MIPPA"
    If basket_number = "X127EH1" then suggested_population = "Adults"
    If basket_number = "X127EH7" then suggested_population = "Adults"
    If basket_number = "X127EH8" then suggested_population = "Adults"
    If basket_number = "X127EK3" then suggested_population = "Adults"
    If basket_number = "X127EK7" then suggested_population = "Adults"
    If basket_number = "X127EK8" then suggested_population = "Adults"
    ...
    If basket_number = "X127EN8" then suggested_population = "Adults"
    If basket_number = "X127EN9" then suggested_population = "Adults"
    If basket_number = "X127EP1" then suggested_population = "Adults"
    If basket_number = "X127EP2" then suggested_population = "Adults"
    If basket_number = "X127EP3" then suggested_population = "Adults"
    ...
    If basket_number = "X127F3H" then suggested_population = "Adults"

    If basket_number = "X127EH4" then suggested_population = "Families"
    If basket_number = "X127EH5" then suggested_population = "Families"
    If basket_number = "X127EH6" then suggested_population = "Families"
    ...
    If basket_number = "X127EZ9" then suggested_population = "Families"
    If basket_number = "X127F4E" then suggested_population = "Families"
    If basket_number = "X127FB7" then suggested_population = "Families"

    If basket_number = "X127F3P" then suggested_population = "Adults - MA-EPD"   'MA-EPD Adults Basket
    ...
    If basket_number = "X127F3K" then suggested_population = "Families - MA-EPD"  'MA-EPD FAD Basket
