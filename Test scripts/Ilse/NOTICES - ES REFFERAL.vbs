...
BeginDialog provider_Hennepin_dialog, 0, 0, 456, 130, "SNAP E&T Appointment Letter"
...
DO
	DO
	    ...
	    err_msg = ""
	    Dialog provider_Hennepin_dialog
	    ...
	    IF interview_location = "Somali-language (Sabathani, next Tuesday @ 2:00 p.m.)" then
	    	...
	    	provider_address_01 = "310 East 38th Street #120"
	    ...
	    Elseif interview_location = "Central NE (HSB, next Wednesday @ 2:00 p.m.)" THEN
	    	provider_name = "Health Services Building"
	    	provider_address_01 = "525 Portland Ave, 5th floor"
	    	provider_city = "Minneapolis"
	    	provider_ST = "MN"
	    	provider_zip = "55415"
	    	appointment_time_prefix_editbox = "02"
	    ...
	    ElseIf interview_location = "Northwest(Brookdale, next Monday @ 2:00 p.m.)" THEN
	    	provider_name = "Brookdale Human Services Center"
	    	provider_address_01 = "6125 Shingle Creek Parkway, Suite 400"
	    ...
	    ElseIf interview_location = "South Mpls (Sabathani, next Tuesday @ 10:00 a.m.)" THEN
	    	provider_name = "Sabathani Community Center"
	    	provider_address_01 = "310 East 38th Street #120"
	    	provider_city = "Minneapolis"
	    	provider_ST = "MN"
	    	provider_zip = "55409"
...
For each member_number in member_array 
    ...
    If memb_error_check = "DOES NOT EXIST" then script_end_procedure ("The HH member " & member_number & " is invalid. Please review your case if necessary. The script will not continue for this member.")
...
For each member_number in member_array 
    ...
    EMWriteScreen provider_name, 9, 28
    EMWriteScreen provider_address_01, 10, 28
    EMWriteScreen provider_city & ", " & provider_ST & " " &  provider_zip, 11, 28
    call create_MAXIS_friendly_phone_number(provider_phone, 13, 28) 'takes out non-digits if listed in variable, and formats phone number for the field
    EMWriteScreen provider_contact, 16, 28
...
For each member_number in member_array
    ...
    EMWriteScreen prog_selection, row, 46								'enters member number
...
EMWriteScreen appointment_date & ", " & appointment_time_prefix_editbox & ":" & appointment_time_post_editbox & " " & AM_PM & ", " & provider_name, 17, 6		'enters the location, date and time for Hennepin Co ES providers (per request)'
PF3			
