...
'DIALOGS-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
BeginDialog case_number_and_footer_month_dialog, 0, 0, 146, 65, "Initial Case Info"
  Text 5, 10, 85, 10, "Enter your case number:"
  EditBox 90, 5, 50, 15, MAXIS_case_number
  Text 20, 30, 65, 10, "Footer month/year:"
  EditBox 90, 25, 20, 15, MAXIS_footer_month
  EditBox 115, 25, 20, 15, MAXIS_footer_year
  ButtonGroup ButtonPressed
    OkButton 45, 45, 45, 15
    CancelButton 95, 45, 45, 15
EndDialog
		...
		Do
			Do
				Do
					...
					If HCAPP_type = "Select one..." or trim(HCAPP_type) = "" then err_msg = err_msg & vbcr & "* Enter or select the type of application."
