...
Do 
    client_PMI = objExcel.cells(excel_row, 1).Value
    If trim(client_PMI) = "" then exit do 
    ...
    call navigate_to_MAXIS_screen("pers", "____")
		...
		If DSPL_confirmation = "DSPL" then 
		    EMWriteScreen "GR", 7, 22	'Selects FS as the program	
		    Transmit
