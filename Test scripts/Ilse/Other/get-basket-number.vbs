...
DO
    ...
    If basket_number = "X127EH2" then population_type = "ADS"
    If basket_number = "X127EH3" then population_type = "ADS"
    ...
    If basket_number = "X127EJ4" then population_type = "ADS"
    If basket_number = "X127EJ7" then population_type = "ADS"
    If basket_number = "X127EJ8" then population_type = "ADS"
    If basket_number = "X127EK1" then population_type = "ADS"
    If basket_number = "X127EK2" then population_type = "ADS"
    If basket_number = "X127EK3" then population_type = "ADS"
    If basket_number = "X127EK4" then population_type = "ADS"
    If basket_number = "X127EK5" then population_type = "ADS"
    If basket_number = "X127EK6" then population_type = "ADS"
    If basket_number = "X127EK7" then population_type = "ADS"
    If basket_number = "X127EK8" then population_type = "ADS"
    If basket_number = "X127EK9" then population_type = "ADS"
    If basket_number = "X127EM1" then population_type = "ADS"
    If basket_number = "X127EM8" then population_type = "ADS"
    If basket_number = "X127EM9" then population_type = "ADS"
    If basket_number = "X127EN6" then population_type = "ADS"
    If basket_number = "X127EP3" then population_type = "ADS"
    If basket_number = "X127EP4" then population_type = "ADS"
    If basket_number = "X127EP5" then population_type = "ADS"
    If basket_number = "X127EP9" then population_type = "ADS"
    If basket_number = "X127F3F" then population_type = "ADS"  'MA-EPD ADS Basket
    If basket_number = "X127FE5" then population_type = "ADS"
    If basket_number = "X127FG3" then population_type = "ADS"
    If basket_number = "X127FH4" then population_type = "ADS"
    If basket_number = "X127FH5" then population_type = "ADS"
    If basket_number = "X127FI2" then population_type = "ADS"
    If basket_number = "X127FI7" then population_type = "ADS"
    ...
    If basket_number = "X127EG5" then population_type = "Adults - GRH Demo"
    ...
    If basket_number = "X127EZ5" then population_type = "Families"
