...
col_to_use = 7 'Starting with 7 because cols 1-6 are already used
...
Else		'If worker numbers are litsted - this will create an array of workers to check
	...
	For each x1_number in x1s_from_dialog
		...
		IF sup_id_check <> "       " Then 					'If this first one is not blank then this person is a supervisor
...
For each worker in worker_array
    ...
    EMReadScreen pnd2_disp_limit, 13, 6, 35             'checking again
	...
	If has_content_check <> "0 Of 0" then
		...
		Do
			...
			Do
                ...
                additional_application_date = ""                          'defaulting the Boolean about multiple application dates to FALSE
...
If case_note_check = checked then 		'all this fun stuff happens
	...
	Do
		...
		Call navigate_to_MAXIS_screen("CASE", "NOTE")				'heading' over to CASE/NOTE
...
row_to_use = 3			'Setting variable for the if...then below
