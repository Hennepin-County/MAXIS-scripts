'GATHERING STATS----------------------------------------------------------------------------------------------------
name_of_script = "NOTICES - MFIP TO SNAP WCOM.vbs"
start_time = timer
...
'Dialogs
BeginDialog case_number_dlg, 0, 0, 366, 100, "MFIP to SNAP WCOM"
  EditBox 90, 60, 270, 15, MFIP_closure_reason
  ButtonGroup ButtonPressed
    OkButton 255, 80, 50, 15
    CancelButton 310, 80, 50, 15
  EditBox 90, 40, 60, 15, MAXIS_case_number
  EditBox 255, 40, 20, 15, approval_month
  EditBox 275, 40, 20, 15, approval_year
  Text 185, 45, 70, 10, "Approval month/year:"
  Text 40, 45, 50, 10, "Case Number: "
  Text 5, 65, 85, 10, "Reason for MFIP closure: "
  Text 15, 80, 235, 10, "NOTE!! MFIP closure will be added to the WCOM. Be clear and concise."
  GroupBox 5, 5, 355, 30, "Purpose of script:"
  Text 15, 15, 335, 15, "To explain the reason of MFIP closure to the client in plain language when SNAP is approved, and MFIP is closing/denied."
EndDialog
