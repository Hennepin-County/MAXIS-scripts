...
function create_interview_questions_array(questions_string, questions) 'TODO add variables for caf_type, info_only to clear initial dialogs, create other dialog
	...
	For each current_question in questions_string
		...
		questions.add trim(current_question(0)), trim(current_question(1))
	Next
End function

questions_string = "7) your mom"

call create_interview_questions_array(questions_string, questions)
