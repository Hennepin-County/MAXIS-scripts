...
BeginDialog Dialog1, 0, 0, 206, 60, "REPT/IEVC"
  GroupBox 5, 5, 195, 30, "About this script:"
  Text 10, 20, 190, 10, "This script will gather match information from REPT/IEVC."
...
objExcel.Cells(1, 14).Value    = "PERIOD"			'N
objExcel.Cells(1, 15).Value    = "DATE CLEARED"		'O' Date cleared
...
objExcel.Cells(1, 21).Value    = "COMMENTS"			'U  OTHER NOTES
objExcel.Cells(1, 22).Value    = "DAILS"			'V  DAILS
objExcel.Cells(1, 23).Value    = "DAIL TYPES"		'W  DAILS
