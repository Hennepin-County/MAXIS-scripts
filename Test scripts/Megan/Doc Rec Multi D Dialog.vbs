...
For maxis_panel_write = 0 to Ubound(form_type_array, 2)	
	...
	If form_type_array(form_type_const, maxis_panel_write) = sf_form_name Then	'Write for SF form
