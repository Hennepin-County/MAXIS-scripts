...
ObjExcel.Cells(1, 15).Value = "Query date and time:"	'Goes back one, as this is on the next row
ObjExcel.Cells(1, 16).Value = now
ObjExcel.Cells(2, 15).Value = "Query runtime (in seconds):"	'Goes back one, as this is on the next row
ObjExcel.Cells(2, 16).Value = timer - query_start_time

'Autofitting columns
For col_to_autofit = 1 to 16
