...
Call changelog_update("01/23/2024", "Retired BULK - CASE TRANSFER script.", "Ilse Ferris, Hennepin County")
Call changelog_update("02/28/2023", "Retired the following BULK scripts: 7th Sacntion Identifier, FSS Info, and MFIP Sanction.", "Ilse Ferris, Hennepin County")
Call changelog_update("03/05/2021", "Retired ADDRESS REPORT script.", "Ilse Ferris, Hennepin County")
...
Function declare_main_menu_dialog(script_category)
    ...
    subcategory_list = "BULK ACTIONS|BULK LISTS|ENHANCED LISTS"
	...
	BeginDialog dialog1, 0, 0, 600, dlg_len, script_category & " scripts main menu dialog"
		...
		For i = 0 to ubound(subcategory_array)
			...
			If subcategory_selected <> subcategory_array(i).subcat_name Then
				...
				PushButton 		subcat_button_position, 20, 					75, 		15, 			subcategory_array(i).subcat_name, 					subcat_button_placeholder
			...
			Else
				If subcategory_array(i).subcat_name = "BULK ACTIONS" Then adjuster = 10
				If subcategory_array(i).subcat_name = "BULK LISTS" Then adjuster = 17
				If subcategory_array(i).subcat_name = "ENHANCED LISTS" Then adjuster = 5
				Text 			subcat_button_position + adjuster, 23, 			65, 		15, 			subcategory_array(i).subcat_name
			End If
			subcat_button_position = subcat_button_position + 75
...
subcategory_string = ""
subcategory_selected = "BULK ACTIONS"
...
Do
	...
	'Creates the dialog
	call declare_main_menu_dialog("Bulk")
	...
	For i = 0 to ubound(script_array)
        ' MsgBox "Name - " & script_array(i).script_name & vbNewLine & "SIR Button - " & script_array(i).SIR_instructions_button & vbNewLine & "URL - " & script_array(i).SharePoint_instructions_URL
