...
For each case_number in case_number_array
	...
	For current_memb = 1 to total_membs
		...
		CARS_use = left(ObjExcel.Cells(CARS_starting_excel_row + 12, current_excel_col).Value, 1)
...
FOR EACH case_number IN case_number_array
	...
	If HC_application = True then
		...
		PF9
		CALL write_variable_in_CASE_NOTE("~~~APPROVED HC~~~")
