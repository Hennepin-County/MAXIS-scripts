...
const excel_col_claim_entered			 = 19 'S  Claim(s) Entered
const excel_col_atr_signed				 = 20 'T' Date signed ATR
const excel_col_evf_rcvd				 = 21 'U' Date EVF Recieved
...
For item = 0 to UBound(match_based_array, 2)
	...
	objExcel.Cells(excel_row, excel_col_period).Value = match_based_array(IEVS_period_const, item)
