...
EMReadScreen income_source, 27, 8, 37
income_source = trim(income_source)

IF instr(income_source, "AMT: $") THEN 
    ...
    income_name = Left(income_source, position)  'establishes employer as being before the deliminator
ELSE 
    income_name = income_source
END IF 
...
start_a_blank_CASE_NOTE
	...
	CALL write_variable_in_CASE_NOTE("* Source information: " & income_source & "  " & source_address)
