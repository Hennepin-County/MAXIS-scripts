...
Call changelog_update("09/20/2017", "Updates made accross the board, including action and case note", "MiKayla Handley, Hennepin County")
...
BeginDialog PARIS_MATCH_CLEARED_dialog, 0, 0, 381, (265 + (add_state * 80)), "NOTES-PARIS MATCH CLEARED FINDINGS"
 ...
 Next
  ...
  GroupBox 205, 130, 	   (160 + (add_state * 80)), 50, "Verification requested:"
...
'if edit_error <> "" then script_end_procedure ("Please review for error. Script will now stop.")
...
Call write_variable_in_CASE_NOTE (Match_month & " PARIS MATCH (" & first_name & ") CLEARED " & resolution_status)
