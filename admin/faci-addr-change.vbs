			...
			ELSE
				...
				ELSE 
					...
					IF ADDR_panel_check = "ADDR" then
						...
						'Clears mailing address
						EMWriteScreen "______________________", 13, 43
						EMWriteScreen "______________________", 14, 43
						EMWriteScreen "_______________", 15, 43
						EMWriteScreen "__", 16, 43
						EMWriteScreen "_______", 16, 52
						
						'Writes in the FACI address for 
						EMWriteScreen "06", 4, 43
						EMWriteScreen "01", 4, 46
						EMWriteScreen "16", 4, 49 
						EMWriteScreen "3231 1st Avenue", 6, 43
						EMWriteScreen "Minneapolis", 8, 43
						EMWriteScreen "MN", 8, 66
						EMWriteScreen "55408", 9, 43
						EMWriteScreen "27", 9, 66
						EMWriteScreen "SF", 9, 74
						EMWriteScreen "N", 10, 43
						EMWriteScreen "N", 10, 74
						'mailing address
						EMWriteScreen "3231 1st Avenue", 13, 43
						EMWriteScreen "Minneapolis", 15, 43
						EMWriteScreen "MN", 16, 43
						EMWriteScreen "55408", 16, 52
