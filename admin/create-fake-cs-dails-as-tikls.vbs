'GATHERING STATS----------------------------------------------------------------------------------------------------
name_of_script = "UTILITIES - CREATE FAKE CS DAILS AS TIKL.vbs"
start_time = timer
...
If UNEA_check <> "UNEA" then script_end_procedure("Not on UNEA")

EMReadScreen income_type, 2, 5, 37
If income_type <> "36" and _
   income_type <> "37" and _
