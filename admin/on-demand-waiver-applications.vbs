        ...
        If ALL_PENDING_CASES_ARRAY(next_action_needed, case_entry) = "SEND APPOINTMENT NOTICE" Then
			...
			IF memo_started = True THEN
                Select Case ALL_PENDING_CASES_ARRAY(written_lang, case_entry)
                    ...
                    '     Call write_variable_in_SPEC_MEMO("Chtoby' zavershit' sobesedovanie po telefonom, pozbonite v Informaczionnuju liniju EZ po telefonu 612-596-1300 s 8:00 do 16:00 s ponedel'nika po pyatniczu.")
