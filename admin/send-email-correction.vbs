...
Select Case correction_process
	Case "Expedited Review"
		...
		If add_hsr_case_note_guidelines_resource = TRUE Then email_body = email_body & "&emsp;&ensp;" & "- HSR Manual: " & "<a href=" & chr(34) & "https://hennepin.sharepoint.com/teams/hs-es-manual/SitePages/Casenote_Guidelines_and_Format.aspx" & chr(34) & ">" & "Case Notes Guidelines and Format" & "</a><br>"
	...
	Case "On Demand Applications"
		...
		If caf_script_used_no_interview_checkbox = checked Then
			...
			email_body = email_body & "<a href=" & chr(34) & "https://hennepin.sharepoint.com/:w:/r/teams/hs-economic-supports-hub/BlueZone_Script_Instructions/NOTES/NOTES%20-%20INTERVIEW.docx" & chr(34) & ">" & "NOTES - INTERVIEW." & "</a>" & "</p>"
