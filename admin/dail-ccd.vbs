...
call changelog_update("10/13/2025", "Added PMI merge message, and updated member turned 60 message to be captured, case noted and deleted.", "Ilse Ferris, Hennepin County")
...
Do
    ...
    Else
        ...
        Else
            ...
            If instr(dail_msg, "AUTO-APPROVED") then 
			...
			Else 
				CALL write_variable_in_case_note("This CASE/NOTE was automatically generated by the DAIL CCD report script. No action beyond case note creation was taken on this DAIL message.")
            PF3 ' save message
			End if
