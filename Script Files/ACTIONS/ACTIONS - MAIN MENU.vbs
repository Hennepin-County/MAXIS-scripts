...
'DIALOGS----------------------------------------------------------------------------------------------------
BeginDialog ACTIONS_scripts_main_menu_dialog, 0, 0, 456, 220, "Actions scripts main menu dialog"
  ButtonGroup ButtonPressed
    CancelButton 400, 200, 50, 15
    ...
    PushButton 5, 65, 75, 10, "Copy panels to Word", COPY_PANELS_TO_WORD_button
    PushButton 5, 80, 55, 10, " FSET sanction", FSET_sanction_button
    PushButton 5, 95, 105, 10, "LTC-Spousal Allocation FIATer", LTC_SPOUSAL_ALLOCATION_FIATER_button
    PushButton 5, 110, 105, 10, "MA-EPD earned income FIATer", MA_EPD_EI_FIAT_button
    PushButton 5, 125, 60, 10, "New job reported", NEW_JOB_REPORTED_button
    PushButton 5, 140, 60, 10, "PA verif request", PA_VERIF_REQUEST_button
    PushButton 5, 155, 70, 10, "Paystubs Received", PAYSTUBS_RECEIVED_button
    PushButton 5, 175, 45, 10, "Send SVES", SEND_SVES_button
    PushButton 5, 190, 55, 10, "Transfer case", TRANSFER_CASE_button
    PushButton 5, 205, 85, 10, "Update worker signature", UPDATE_WORKER_SIGNATURE_button
  ...
  Text 85, 65, 180, 10, "--- Copies MAXIS panels to Word en masse for a case."
  Text 115, 95, 175, 10, "--- FIATs a spousal allocation across a budget period."
  Text 115, 110, 295, 10, "--- FIATs MA-EPD earned income (JOBS income) to be even across an entire budget period."
  Text 70, 125, 380, 10, "--- Creates a JOBS panel, CASE/NOTE and TIKL when a new job is reported. Use the DAIL scrubber for new hire DAILs."
  Text 70, 140, 320, 10, "--- Creates a Word document with PA benefit totals for other agencies to determine client benefits."
  Text 80, 155, 370, 20, "--- Enter in paystubs on one dialog, and it puts that information on JOBS (both retrospective and prospective if applicable), as well as the PIC and HC pop-up, and it'll case note the income as well."
  Text 55, 175, 90, 10, "--- Sends a SVES/QURY."
  Text 65, 190, 325, 10, "--- SPEC/XFERs a case, and can send a client memo. For in-agency as well as out-of-county XFERs."
  Text 95, 205, 185, 10, "--- Updates the default worker signature on your scripts."
  ...
  Text 70, 80, 365, 10, "--- NEW 07/2015!!! -- Updates the WREG panel, and case notes when imposing or resolving a FSET sanction."
EndDialog
