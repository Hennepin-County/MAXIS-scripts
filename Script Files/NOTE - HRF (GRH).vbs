...
BeginDialog HRF_dialog, 0, 0, 451, 245, "HRF dialog"
  ...
  CheckBox 125, 210, 180, 10, "Check here to case note grant info from ELIG/GRH.", grab_GRH_info_check
  CheckBox 125, 225, 180, 10, "Check here if post-pay released to facility.", grab_current_date
  EditBox 380, 205, 65, 15, worker_signature
  ButtonGroup ButtonPressed
    OkButton 340, 225, 50, 15
    CancelButton 395, 225, 50, 15
    PushButton 280, 20, 20, 10, "GRH", ELIG_MFIP_button
    PushButton 300, 20, 20, 10, "HC", ELIG_HC_button
    ...
    PushButton 85, 210, 20, 10, "FACI", FACI_button
  GroupBox 275, 5, 50, 30, "ELIG panels"
  ...
  GroupBox 5, 195, 105, 30, "other STAT panels"
...
call write_editbox_in_case_note("Date check sent to facility", grab_current_date, 6)
