'STATS GATHERING----------------------------------------------------------------------------------------------------
name_of_script = "BULK - INAC scrubber"
start_time = timer
...
ReDim INAC_scrubber_primary_array(total_cases, 7)
...
For x = 0 to total_cases
	...
	If developer_mode = True then ObjExcel.Cells(x + 2, 6).Value = INAC_scrubber_primary_array(x, 5)		'Writes MMIS status to array when developer_mode is on
Next
