...
Call Call write_variable_in_CASE_NOTE("* Updated RLVA and FACI.")
Else
  If updated_RLVA_check = 1 then Call Call write_variable_in_CASE_NOTE("* Updated RLVA.")
  If updated_FACI_check = 1 then Call Call write_variable_in_CASE_NOTE("* Updated FACI.")
End if
If need_3543_check = 1 then Call Call write_variable_in_CASE_NOTE("* A 3543 is needed.")
If sent_3050_check = 1 then call Call write_variable_in_CASE_NOTE("* Sent 3050.")
...
If processed_1503_check = 1 then Call Call write_variable_in_CASE_NOTE("* Completed & Returned 1503 to LTCF.")
If TIKL_check = 1 then Call Call write_variable_in_CASE_NOTE("* TIKLed to recheck length of stay on " & TIKL_date & ".")
Call Call write_variable_in_CASE_NOTE("---")
