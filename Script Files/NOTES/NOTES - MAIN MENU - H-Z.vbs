...
'DIALOGS----------------------------------------------------------------------------------------------------
BeginDialog NOTES_H_Z_scripts_main_menu_dialog, 0, 0, 456, 325, "Notes (H-Z) scripts main menu dialog"
  ButtonGroup ButtonPressed
    ...
    PushButton 10, 205, 80, 10, "LTC - Transfer penalty", LTC_TRANSFER_PENALTY_button
    PushButton 10, 220, 110, 10, "Medical Opinion Form received", MEDICAL_OPINION_FORM_RECEIVED_button
    PushButton 10, 235, 125, 10, "MFIP sanction/DWP disqualification", MFIP_SANCTION_AND_DWP_DISQUALIFICATION_button
    PushButton 10, 250, 110, 10, "Mileage reimbursement request", MILEAGE_REIMBURSEMENT_REQUEST_button
    PushButton 10, 265, 110, 10, "MNsure - Documents requested", MNSURE_DOCUMENTS_REQUESTED_button
    PushButton 10, 280, 50, 10, "Overpayment", OVERPAYMENT_button
    PushButton 10, 295, 80, 10, "Shelter Form received", SHELTER_FORM_RECEIVED_button
    PushButton 10, 310, 75, 10, "Verifications needed", VERIFICATIONS_NEEDED_button
  ...
  Text 95, 205, 225, 10, "--- NEW 04/2015!!! A case note template for noting a transfer penalty."
  Text 125, 220, 280, 10, "--- NEW 04/2015!!! A case note template for information about a medical opinion form."
  Text 140, 235, 290, 10, "--- A case note template for MFIP sanctions and DWP disqualifications, both CS and ES."
  Text 125, 250, 260, 10, "--- A case note template for actions taken on medical mileage reimbursements."
  Text 125, 265, 250, 10, "--- A case note template for when MNsure documents have been requested."
  Text 65, 280, 240, 10, "--- A case note template for noting basic information about overpayments."
  Text 95, 295, 250, 10, "--- NEW 04/2015!!! A case note template for noting Shelter Form information."
