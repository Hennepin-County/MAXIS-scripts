...
End if
If elig_date_01 <> "" then call Call write_variable_in_CASE_NOTE("* Elig type/std for " & elig_date_01 & ": " & replace(elig_type_std_01, "/_", "") & ", method " & elig_method_01 & replace(", waiver type " & elig_waiver_type_01, ", waiver type _", "") & ".")
If elig_date_02 <> "" then call Call write_variable_in_CASE_NOTE("* Elig type/std for " & elig_date_02 & ": " & replace(elig_type_std_02, "/_", "") & ", method " & elig_method_02 & replace(", waiver type " & elig_waiver_type_02, ", waiver type _", "") & ".")
If elig_date_03 <> "" then call Call write_variable_in_CASE_NOTE("* Elig type/std for " & elig_date_03 & ": " & replace(elig_type_std_03, "/_", "") & ", method " & elig_method_03 & replace(", waiver type " & elig_waiver_type_03, ", waiver type _", "") & ".")
If elig_date_04 <> "" then call Call write_variable_in_CASE_NOTE("* Elig type/std for " & elig_date_04 & ": " & replace(elig_type_std_04, "/_", "") & ", method " & elig_method_04 & replace(", waiver type " & elig_waiver_type_04, ", waiver type _", "") & ".")
If elig_date_05 <> "" then call Call write_variable_in_CASE_NOTE("* Elig type/std for " & elig_date_05 & ": " & replace(elig_type_std_05, "/_", "") & ", method " & elig_method_05 & replace(", waiver type " & elig_waiver_type_05, ", waiver type _", "") & ".")
If elig_date_06 <> "" then call Call write_variable_in_CASE_NOTE("* Elig type/std for " & elig_date_06 & ": " & replace(elig_type_std_06, "/_", "") & ", method " & elig_method_06 & replace(", waiver type " & elig_waiver_type_06, ", waiver type _", "") & ".")
...
If DHS_5181_on_file_check = 1 then call Call write_variable_in_CASE_NOTE("* DHS-5181 on file.")
If DHS_1503_on_file_check = 1 then call Call write_variable_in_CASE_NOTE("* DHS-1503 on file.")
...
If community_check = 1 then call Call write_variable_in_CASE_NOTE("* Client is in the community.")
...
If INSA_loaded_into_TPL_check = 1 then call Call write_variable_in_CASE_NOTE("* INSA loaded into TPL.")
If LTC_partnership_check = 1 then call Call write_variable_in_CASE_NOTE("* There is a LTC partnership for this case.")
...
If DHS_3050_1503_check = 1 then call Call write_variable_in_CASE_NOTE("* DHS-3050/1503 sent.")
If DHS_3203_lien_doc_check = 1 then call Call write_variable_in_CASE_NOTE("* DHS-3203/lien doc sent.")
If asset_transfer_letter_sent_check = 1 then call Call write_variable_in_CASE_NOTE("* Asset transfer letter sent.")
If managed_care_referral_sent_check = 1 then call Call write_variable_in_CASE_NOTE("* Managed care referral sent.")
