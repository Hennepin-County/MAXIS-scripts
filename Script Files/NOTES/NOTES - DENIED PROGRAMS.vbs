...
If cash_denial_date <> "" then call write_bullet_and_variable_in_case_note("cash denial date", cash_denial_date, 6)
If emer_denial_date <> "" then call write_bullet_and_variable_in_case_note("Emer denial date", emer_denial_date, 6)
...
If case_noting_intake_dates = True then
	...
	If cash_check = 1 then call write_bullet_and_variable_in_case_note("Last cash REIN date", cash_last_REIN_date, 6)
	If emer_check = 1 then call write_bullet_and_variable_in_case_note("Last emer REIN date", emer_last_REIN_date, 6)
