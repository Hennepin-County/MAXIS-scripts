...
script_array_R_to_Z(script_num).file_name				= "NOTES - RETURNED MAIL.vbs"
script_array_R_to_Z(script_num).description				= "Template for noting Returned Mail information."
