...
BeginDialog opening_dialog_01, 0, 0, 311, 420, "LTC Burial Assets"
  EditBox 95, 20, 60, 15, case_number
  EditBox 225, 20, 30, 15, hh_member
  DropListBox 165, 40, 90, 15, "Select one..."+chr(9)+"GA"+chr(9)+"Health Care"+chr(9)+"MFIP/DWP"+chr(9)+"MSA/GRH", programs
  EditBox 135, 60, 120, 15, worker_signature
  ...
  Text 40, 25, 50, 10, "Case Number:"
  Text 175, 25, 45, 10, "HH Member:"
  Text 40, 65, 95, 10, "Please sign your case note:"
  ...
  Text 40, 45, 125, 10, "Program asset is being evaluated for"
  GroupBox 35, 10, 230, 70, "Case and Worker Information"
...
BeginDialog burial_assets_dialog_01, 0, 0, 301, 190, "Burial assets dialog (01)"
  ...
  DropListBox 95, 40, 50, 15, "Select One..."+chr(9)+"None"+chr(9)+"AFB"+chr(9)+"CSA"+chr(9)+"IBA"+chr(9)+"IFB"+chr(9)+"RBA", type_of_burial_agreement
  ...
  CheckBox 5, 105, 280, 10, "Primary beneficiary is : Any funeral provider whose interest may appear irrevocably", Primary_benficiary_check
  CheckBox 5, 120, 175, 10, "Contingent Beneficiary is: The estate of the insured ", Contingent_benficiary_check
  CheckBox 5, 135, 215, 10, "Policy's CSV is irrevocably designated to the funeral provider", policy_CSV_check
  ButtonGroup ButtonPressed
    PushButton 65, 165, 50, 15, "Previous", previous
    PushButton 125, 165, 50, 15, "Next", next_button
    CancelButton 185, 165, 50, 15
...
BeginDialog burial_assets_dialog_04, 0, 0, 306, 370, "Burial Assets Dialog (04)"
  ...
  ButtonGroup ButtonPressed
    PushButton 75, 340, 50, 15, "previous", previous_button
