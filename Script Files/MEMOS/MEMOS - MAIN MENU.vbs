...
'DIALOGS----------------------------------------------------------------------------------------------------
BeginDialog MEMOS_scripts_main_menu_dialog, 0, 0, 456, 230, "Memos scripts main menu dialog"
  ButtonGroup ButtonPressed
    CancelButton 400, 205, 50, 15
    ...
    PushButton 5, 120, 60, 10, "MFIP orientation", MFIP_ORIENTATION_button
    PushButton 5, 135, 55, 10, "MNsure memo", MNSURE_MEMO_button
    PushButton 5, 150, 25, 10, "NOMI", NOMI_button
    PushButton 5, 165, 55, 10, "Overdue baby", OVERDUE_BABY_button
    PushButton 5, 190, 70, 10, "SNAP E and T letter", SNAP_E_AND_T_LETTER_button
  ...
  Text 115, 65, 305, 10, "--- Adds a WCOM to a notice for duplicate assistance explaining why the client was ineligible."
  Text 140, 80, 310, 20, "--- NEW 06/2015!!! Sends a MEMO to a facility indicating that an overpayment is due because a client left."
  Text 80, 105, 200, 10, "--- Sends a MEMO to a LTC client regarding asset transfers."
  Text 70, 120, 185, 10, "--- Sends a MEMO to a client regarding MFIP orientation."
  Text 65, 135, 160, 10, "--- Sends a MEMO to a client regarding MNsure."
  Text 35, 150, 375, 10, "--- Sends the SNAP notice of missed interview (NOMI) letter, following rules set out in POLI/TEMP TE02.05.15."
  Text 65, 165, 385, 20, "--- Sends a MEMO informing client that they need to report information regarding the birth of their child, and/or pregnancy end date, within 10 days or their case may close."
  Text 80, 190, 355, 10, "--- NEW 06/2015!!! Sends a MEMO informing client that they have an Employment and Training appointment."
EndDialog
