...
'DIALOGS-------------------------------------------------------------------------------------------------------------
BeginDialog EXP_SNAP_review_dialog, 0, 0, 286, 125, "EXP SNAP review "
  EditBox 75, 30, 205, 15, worker_number
  CheckBox 5, 70, 150, 10, "Check here to run this query county-wide ", all_workers_check
  ButtonGroup ButtonPressed
    OkButton 175, 105, 50, 15
    CancelButton 230, 105, 50, 15
  Text 5, 35, 65, 10, "Worker(s) to check:"
  Text 20, 85, 250, 20, "NOTE: running queries county-wide can take a significant amount of time and resources. This should be done after hours."
  Text 5, 5, 275, 15, "This script will create a list of cases that should be reviewed for EXP SNAP eligibilty from REPT PND1 and PND2."
  Text 5, 50, 275, 10, "Enter all 7 digits of your workers' x1 numbers (ex: x######), separated by a comma."
EndDialog
...
'msgbox "appl date into Excel: " & APPL_date
