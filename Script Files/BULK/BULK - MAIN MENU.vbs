...
FUNCTION create_BULK_main_menu(dialog_name)
	...
	ELSEIF dialog_name = "BULK LISTS" THEN
		BeginDialog dialog_name, 0, 0, 456, 285, "BULK List Generators"
		  ...
		  Text 235, 210, 210, 20, "--- Creates a list of cases with non-MAGI HC deductions."
		  Text 185, 235, 260, 20, "--- Creates a list of SWKRs assigned to the various cases in a caseload (or group of caseloads)."
