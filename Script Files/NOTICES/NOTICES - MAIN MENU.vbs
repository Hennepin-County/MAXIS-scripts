...
'DIALOGS----------------------------------------------------------------------------------------------------
BeginDialog NOTICES_scripts_main_menu_dialog, 0, 0, 451, 285, "Notices scripts main menu dialog"
  ...
  Text 5, 5, 235, 10, "Notices scripts main menu: select the script to run from the choices below."
...
Do
	dialog NOTICES_scripts_main_menu_dialog
