...
'STATS GATHERING----------------------------------------------------------------------------------------------------
name_of_script = "NOTE - Interview Note"
start_time = timer
...
BeginDialog docs_received_dialog, 0, 0, 466, 145, "Interview Note"
  EditBox 55, 5, 90, 15, case_number
  EditBox 225, 5, 90, 15, interview_date
  EditBox 60, 25, 215, 15, issues
  EditBox 120, 45, 390, 15, programs
  EditBox 60, 65, 405, 15, actions_taken
  EditBox 70, 85, 110, 15, worker_signature
  CheckBox 195, 85, 205, 10, "R/R Explained ", explained
  CheckBox 195, 95, 200, 10, "Expedited ", expedited
  EditBox 115, 120, 350, 15, docs_needed
  ButtonGroup ButtonPressed
    OkButton 355, 5, 50, 15
    CancelButton 410, 5, 50, 15
  Text 5, 10, 50, 10, "Case number:"
  Text 170, 10, 50, 10, "Interview Date:"
  Text 5, 30, 55, 10, "Issues/Other:"
  Text 5, 50, 100, 10, "Programs Active/Requested:"
  Text 280, 30, 190, 10, "Note: List issues such as FACI/SANC/ABAWD/DISA"
...
'Case notes
EMSendKey "<home> " & "Interview Date: " & interview_date & "<newline>" 
call write_editbox_in_case_note("Issues", issues, 6)
call write_editbox_in_case_note("Programs Active/Requested", programs, 6)
call write_editbox_in_case_note("Actions taken", actions_taken, 6) 
call write_editbox_in_case_note("Verifications needed", docs_needed, 6)
If explained = 1 then call write_new_line_in_case_note("R/R explained to client.")
If expedited = 1 then call write_new_line_in_case_note("SNAP is expedited.")
