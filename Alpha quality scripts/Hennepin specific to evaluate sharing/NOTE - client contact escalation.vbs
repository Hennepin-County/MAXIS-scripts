...
'STATS GATHERING----------------------------------------------------------------------------------------------------
name_of_script = "NOTE - escalated client contact"
start_time = timer

'FUNCTIONS----------------------------------------------------------------------------------------------------
'LOADING ROUTINE FUNCTIONS----------------------------------------------------------------------------------------------------
Set run_another_script_fso = CreateObject("Scripting.FileSystemObject")
Set fso_command = run_another_script_fso.OpenTextFile("C:\Users\wfr289\Desktop\MNsure Script Test\FUNCTIONS FILE.vbs")
...
'  DropListBox 50, 5, 60, 15, "Phone"+chr(9)+"Walk-in", contact_type
...
'  Text 5, 10, 45, 10, "Escalation type:"
...
BeginDialog contact_dialog, 0, 0, 386, 255, "Client contact - escalation"
  DropListBox 80, 5, 60, 15, "Phone call"+chr(9)+"Walk-in", contact_type
  EditBox 260, 5, 60, 15, worker_id 
  EditBox 105, 35, 60, 15, phone_number
  EditBox 285, 35, 85, 15, when_voicemail_was_left
  EditBox 55, 60, 85, 15, case_number
  ...
  Text 5, 10, 60, 20, "Escalation type:"
  Text 170, 10, 80, 10, " Escalating Worker ID:"
  GroupBox 5, 25, 370, 30, "Optional info:"
  Text 20, 40, 70, 10, "Client Phone number: "
  Text 195, 40, 85, 10, "When was contact made: "
  Text 5, 65, 50, 10, "Case number: "
  Text 5, 85, 65, 10, "Reason for contact:"
  Text 5, 105, 50, 10, "Actions taken: "
...
If isnumeric(case_number) = True then
  ...
  If worker_id <> "" then EMSendKey " Worker ID: " & worker_id 
  EMSendKey "<newline>"
