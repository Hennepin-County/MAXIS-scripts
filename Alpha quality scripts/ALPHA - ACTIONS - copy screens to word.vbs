...
BeginDialog all_MAXIS_panels_dialog, 0, 0, 371, 190, "All MAXIS panels dialog"
  ...
  Checkbox 260, 70, 35, 10, "SECU", SECU_check
  ...
  Checkbox 260, 145, 35, 10, "REVW", REVW_check
...
For each panel_to_scan in all_panels_selected_array
	IF panel_to_scan = "TYPE" OR _	'These panels are case-specific rather than member-specific (as in, one per case only)
