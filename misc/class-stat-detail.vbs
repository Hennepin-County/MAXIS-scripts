	...
	public sub gather_stat_info()
		...
		For each_memb = 0 to UBound(stat_memb_ref_numb)
			...
			If stat_unea_one_exists(each_memb) = True Then
				...
				If stat_unea_one_type_code(each_memb) = "31" Then stat_unea_one_type_info(each_memb) = "Other FS Only"
			...
			If stat_unea_two_exists(each_memb) = True Then
				...
				If stat_unea_two_type_code(each_memb) = "31" Then stat_unea_two_type_info(each_memb) = "Other FS Only"
			...
			If stat_unea_three_exists(each_memb) = True Then
				...
				If stat_unea_three_type_code(each_memb) = "31" Then stat_unea_three_type_info(each_memb) = "Other FS Only"
			...
			If stat_unea_four_exists(each_memb) = True Then
				...
				If stat_unea_four_type_code(each_memb) = "31" Then stat_unea_four_type_info(each_memb) = "Other FS Only"
			...
			If stat_unea_five_exists(each_memb) = True Then
				...
				If stat_unea_five_type_code(each_memb) = "31" Then stat_unea_five_type_info(each_memb) = "Other FS Only"
